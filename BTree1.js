...
(function(module, console) {
    ...
    btree.create = function(order, compare) {
        ...
        TreeNode.prototype.put = function(key, value, overwrite) {
            ...
            const node = result.node, index = result.index;
        ...
        TreeNode.prototype.balance = function() {
            ...
            const index = asearch(this.parent.nodes, this), left = index > 0 ? this.parent.nodes[index - 1] : null, right = this.parent.nodes.length > index + 1 ? this.parent.nodes[index + 1] : null;
            let sep, leaf, rest;
        ...
        TreeNode.prototype.toString = function(includeNodes) {
            ...
            let s =
                `[${val.toString()}]${this.parent instanceof Tree ? ':*' : `:${this.parent}`}`;
            if (includeNodes) {
         ...
         * @constructor
         */
        const Leaf = function(parent, key, value) {
            /**
             * Parent node.
             * @type {!TreeNode}
             */
